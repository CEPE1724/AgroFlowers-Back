    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .hasAnyRole("ADMIN", "SUPERVISOR", "OPERADOR")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/flowers/**")
                        .hasAnyRole("ADMIN", "SUPERVISOR", "OPERADOR")

                        .requestMatchers(HttpMethod.POST, "/api/flowers")
                        .hasRole("ADMIN")

                        .requestMatchers(HttpMethod.PUT, "/api/flowers/**")
                        .hasRole("ADMIN")
